...
SERVICES = {
    ...
    'the-ledger':         {'name': 'The Ledger',          'port': 5020,  'url': f'http://{LAN}:5020',  'type': 'ck',    'path': os.path.join(CK_BASE, 'The Ledger'),        'cmd': 'node server.js', 'health': '/'},
    ...
    'junk-drawer-api':    {'name': 'Junk Drawer API',     'port': 5006,  'url': f'http://{LAN}:5006',  'type': 'infra', 'path': os.path.join(CK_BASE, 'Junk Drawer file management system', 'junk-drawer-backend'), 'cmd': 'python app.py', 'health': '/api/health', 'env': {'JUNK_DRAWER_PORT': '5006'}},
